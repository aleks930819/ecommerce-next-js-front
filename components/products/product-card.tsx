    ...
    >
      <div className='aspect-square roundex-xl relative'>
        <Image
          ...
          height={300}
          loading='lazy'
          className='object-cover w-full h-full sm:group-hover:hidden   transition duration-1000 ease-in-out rounded-t-xl'
        ...
        <Image
          ...
          loading='lazy'
          onClick={handleClickRedirect}
          className='hidden sm:group-hover:block object-cover w-full h-full absolute top-0 left-0   transition duration-1000 ease-in-out  rounded-t-xl '
        />
